...
## train set location
config.TRAIN.hr_img_path = '/content/drive/My Drive/data/train_HR'
config.TRAIN.lr_img_path = '/content/drive/My Drive/data/train_LR'

config.VALID = edict()
## test set location
config.VALID.hr_img_path = '/content/drive/My Drive/data/valid_HR'
config.VALID.lr_img_path = '/content/drive/My Drive/data/valid_LR'
